...
export const STRINGS = {
  ...
  output: {
    ...
    emailTitle: "Want occasional product updates? (optional)",
    emailPlaceholder: "you@agency.com",
    emailSubmit: "Keep me posted",
    emailConfirm: "✓ Thanks — we'll only email when there's something worth it.",
    emailSmallprint: "No spam. No sales calls. Unsubscribe anytime.",
  },
  errors: {
